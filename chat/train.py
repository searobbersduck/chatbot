            ...
            try:
                while not sess.should_stop():
                    ...
                    if step % 100 == 0:
                        ...
                        # print('train predictions:\t', ''.join(tokenizer.convert_ids_to_tokens(train_val[0])))
                        # print('train predictions:\t', ''.join(tokenizer.convert_ids_to_tokens(train_val[1])))
                        # print('train predictions:\t', ''.join(tokenizer.convert_ids_to_tokens(train_val[2])))
                        # print('train predictions:\t', ''.join(tokenizer.convert_ids_to_tokens(train_val[3])))
                        print(train_val)
                        ...
                        print('predictions:\t', ''.join(tokenizer.convert_ids_to_tokens(eval_val[0][3])))
                        print('\n')
